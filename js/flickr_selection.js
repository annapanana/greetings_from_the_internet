...
function searchFlickr(searchText, page) {
  ...
  var $xhr = $.getJSON('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=895b279df6ecc35b1e91b50a62dd8d4f&tags='+searchText+'&safe_search=true&has_geo=true&content_type=1&per_page=60&page=' + page + '&format=json&nojsoncallback=1');
